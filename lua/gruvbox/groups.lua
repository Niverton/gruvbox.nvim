...
M.setup = function()
  ...
  local groups = {
    ...
    DiffDelete = config.diff_syntax_highlight and { bg = colors.bg0_red } or { fg = colors.red, bg = colors.bg0, reverse = config.inverse },
    DiffAdd = config.diff_syntax_highlight and { bg = colors.bg0_green } or { fg = colors.green, bg = colors.bg0, reverse = config.inverse },
    DiffChange = config.diff_syntax_highlight and { bg = colors.bg0_blue } or { fg = colors.aqua, bg = colors.bg0, reverse = config.inverse },
    DiffText = config.diff_syntax_highlight and { bg = colors.bg0_yellow } or { fg = colors.yellow, bg = colors.bg0, reverse = config.inverse },
